...
const isValidUsername_1 = __importDefault(__webpack_require__(/*! ./isValidUsername */ "./src/isValidUsername.ts"));
const isValidPassword_1 = __importDefault(__webpack_require__(/*! ./isValidPassword */ "./src/isValidPassword.ts"));
...
form.addEventListener('submit', function (event) {
    ...
    if (!(0, isNotEmpty_1.default)([emailInput, userInput, passwordInput, confirmInput])) {
        ...
        if (!(0, isValidUsername_1.default)(userInput.value)) {
        ...
        if (!(0, isValidPassword_1.default)(passwordInput.value, confirmInput.value)) {
